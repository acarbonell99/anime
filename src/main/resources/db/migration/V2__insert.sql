...
INSERT INTO anime(name, description, type, year, imageurl) VALUES
    ...
    ('Dragon Ball','Dragon Ball narra la historia de Goku, un excepcional niño que llegó a la Tierra en una cápsula durante una noche tormentosa. Sin saber nada de su pasado, un anciano lo cuidó como su nieto hasta los ocho años. Después de morir su abuelo, Goku accede a la Kame House, lugar donde un estrambótico anciano le convertirá en un campeón de artes marciales. Conocerá por el camino a Bulma, una muchacha obsesionada con algo denominado las Bolas de Dragón, y Krilin, su compañero de aventuras, entre otros...', 'Serie de TV', 1986, 'https://static.wikia.nocookie.net/doblaje/images/4/4a/DragonBall.jpeg/revision/latest/top-crop/width/360/height/450?cb=20200915224214&path-prefix=es'),
    ('Tengen Toppa Gurren Lagann','El pueblo de Jiiha es uno de los tantos pueblos subterráneos que hay en el mundo. Muchos de sus habitantes se dedican a excavar con sus taladros, expandiendo horizontalmente el territorio del pueblo, ya que desde hace mucho tiempo, existe una prohibición por la cual nadie puede subir a la "superficie". Simon es uno de esos excavadores que, un día, mientras realiza su trabajo, descubre algo excepcional que le conducirá a vivir una nueva vida más allá de Jiiha. Animado por su compañero Kamina, se despedirán para siempre de su pueblo natal y descubrirán un mundo nuevo donde el único límite que existe por encima de ellos es el gran cielo azul.', 'Serie de TV', 2007, 'https://www.srgeekarg.com/wp-content/uploads/2018/11/26f6484f18efa8128fe8f7edb167b7ba.jpg');
